...
**[2026/08/16]** ComfyUI custom nodes wrap the paper inference path (first frame + prompt + camera action → frames). Listed on the [Comfy Registry](https://registry.comfy.org/publishers/wayne-king) (`@wayne-king`). Clone this repo into `ComfyUI/custom_nodes/`, or symlink [`comfyui/`](comfyui/).
