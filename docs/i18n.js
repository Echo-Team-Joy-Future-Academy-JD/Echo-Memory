...
window.ECHO_I18N = {
  en: {
    ...
    "updates.news_comfyui": "ComfyUI custom nodes wrap the paper inference path (first frame + prompt + camera action). Listed on the <a href=\"https://registry.comfy.org/publishers/wayne-king\" target=\"_blank\" rel=\"noopener noreferrer\">Comfy Registry</a> (<code>@wayne-king</code>). Clone this repo into <code>ComfyUI/custom_nodes/</code>, or symlink <a href=\"https://github.com/Echo-Team-Joy-Future-Academy-JD/Echo-Memory/tree/main/comfyui\" target=\"_blank\" rel=\"noopener noreferrer\"><code>comfyui/</code></a>.",
    "updates.news_frameworks": "Submitted a DiffSynth-Studio Wan example / optional <code>context_k1</code> overlay (<a href=\"https://github.com/modelscope/DiffSynth-Studio/pull/1592\" target=\"_blank\" rel=\"noopener noreferrer\">PR #1592</a>). Converted the same row to Diffusers keys and opened a community pipeline (<a href=\"https://github.com/huggingface/diffusers/pull/14471\" target=\"_blank\" rel=\"noopener noreferrer\">PR #14471</a>; Hub: <a href=\"https://huggingface.co/Wayne-King/echo-memory-diffusers\" target=\"_blank\" rel=\"noopener noreferrer\">Wayne-King/echo-memory-diffusers</a>).",
    "updates.news_demo": "Interactive demo on Hugging Face Spaces (ZeroGPU): <a href=\"https://huggingface.co/spaces/hugging-apps/echo-memory\" target=\"_blank\" rel=\"noopener noreferrer\">hugging-apps/echo-memory</a>. No local GPU required.",
    "updates.news_ckpt": "Validated paper checkpoints published on <a href=\"https://huggingface.co/Echo-Team/Echo-Memory\" target=\"_blank\" rel=\"noopener noreferrer\"><strong>Echo-Team/Echo-Memory</strong></a> (<code>context_k1</code>, <code>framepack_len_r8</code>, <code>block_wise_ssm_causal_v2</code>).",
  ...
  zh: {
    ...
    "updates.news": "新闻",
    "updates.roadmap": "路线图",
    "updates.news_comfyui": "ComfyUI 自定义节点已接入论文推理路径（首帧 + 文本 + 相机动作），已上架 <a href=\"https://registry.comfy.org/publishers/wayne-king\" target=\"_blank\" rel=\"noopener noreferrer\">Comfy Registry</a>（<code>@wayne-king</code>）。把本仓库 clone 进 <code>ComfyUI/custom_nodes/</code>，或软链 <a href=\"https://github.com/Echo-Team-Joy-Future-Academy-JD/Echo-Memory/tree/main/comfyui\" target=\"_blank\" rel=\"noopener noreferrer\"><code>comfyui/</code></a>。",
    "updates.news_frameworks": "已向 DiffSynth-Studio 提交 Wan 示例 / 可选 <code>context_k1</code> 叠加（<a href=\"https://github.com/modelscope/DiffSynth-Studio/pull/1592\" target=\"_blank\" rel=\"noopener noreferrer\">PR #1592</a>）。同一行权重已转到 Diffusers 键名，并提交 community pipeline（<a href=\"https://github.com/huggingface/diffusers/pull/14471\" target=\"_blank\" rel=\"noopener noreferrer\">PR #14471</a>；Hub：<a href=\"https://huggingface.co/Wayne-King/echo-memory-diffusers\" target=\"_blank\" rel=\"noopener noreferrer\">Wayne-King/echo-memory-diffusers</a>）。",
    "updates.news_demo": "Hugging Face Spaces 交互 Demo 上线（ZeroGPU）：<a href=\"https://huggingface.co/spaces/hugging-apps/echo-memory\" target=\"_blank\" rel=\"noopener noreferrer\">hugging-apps/echo-memory</a>，无需本地 GPU。",
    "updates.news_ckpt": "论文对齐权重已发布到 <a href=\"https://huggingface.co/Echo-Team/Echo-Memory\" target=\"_blank\" rel=\"noopener noreferrer\"><strong>Echo-Team/Echo-Memory</strong></a>（<code>context_k1</code>、<code>framepack_len_r8</code>、<code>block_wise_ssm_causal_v2</code>）。",
