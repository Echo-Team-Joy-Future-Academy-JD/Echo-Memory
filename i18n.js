...
window.ECHO_I18N = {
  en: {
    ...
    "updates.news0": "Bilingual project page and <a href=\"developer.html\">Developer Guide</a> — dev workflows, Cursor vibe coding, EN/中文 side-by-side.",
    ...
    "dev.subtitle": "Development workflows, training/eval, and Cursor vibe coding — not a README duplicate.",
    ...
    "dev.s5.body": "Replace <code>docs/assets/wechat_group_qrcode.jpg</code> and <code>assets/wechat_group_qrcode.jpg</code> when the group QR refreshes. Use the <strong>full WeChat screenshot</strong> as-is (no crop), then republish gh-pages.",
  ...
  zh: {
    ...
    "updates.news": "新闻",
    "updates.roadmap": "路线图",
    "updates.news0": "项目页双语 + <a href=\"developer.html\">开发者指南</a>：开发流程、Cursor 协作、中英对照。",
    ...
    "dev.title": "开发者手册",
    "dev.subtitle": "开发流程、训练评测与 Cursor 协作 — 非 README 重复版。",
    "dev.back": "← 返回项目页",
    "dev.s1.title": "1. 仓库结构",
    ...
    "dev.s5.body": "二维码更新时替换 <code>docs/assets/wechat_group_qrcode.jpg</code> 与 <code>assets/wechat_group_qrcode.jpg</code>。直接放入<strong>完整微信截图</strong>（无需裁剪），然后重新发布 gh-pages。",
