...
window.ECHO_I18N = {
  en: {
    ...
    "evidence.dynamic.note": "Dynamic previews use one randomly selected training scene replayed with the same first frame, prompt, and GT camera trajectory across all six rows.",
  ...
  zh: {
    ...
    "evidence.dynamic.note": "动态预览来自一个随机训练场景；六组使用相同首帧、prompt 与 GT 相机轨迹 replay。",
