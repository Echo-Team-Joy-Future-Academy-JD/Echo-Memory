...
window.ECHO_I18N = {
  en: {
    ...
    "dev.s5.body": "Replace <code>docs/assets/wechat_group_qrcode.jpg</code> and <code>assets/wechat_group_qrcode.jpg</code> when the group QR refreshes. Crop to the square QR region (drop WeChat header/footer chrome) so the page can scale it proportionally, then republish gh-pages.",
  ...
  zh: {
    ...
    "dev.s5.body": "二维码更新时替换 <code>docs/assets/wechat_group_qrcode.jpg</code> 与 <code>assets/wechat_group_qrcode.jpg</code>。建议只保留正方形二维码区域（去掉微信截图顶栏/底栏），页面会等比例缩放显示，然后重新发布 gh-pages。",
