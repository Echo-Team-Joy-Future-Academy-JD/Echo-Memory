...
MEMORY_PROFILE_REGISTRY: List[MemoryProfileSpec] = [
    MemoryProfileSpec(
        ...
        ckpt_substrings=("memory_baselines_basic_framepack_weight_only",),
    ...
    MemoryProfileSpec(
        ...
        ckpt_substrings=("memory_baselines_basic_framepack_lencompress_r2",),
        paper_tag="arXiv:2504.12626",
        train_flags=("--use_framepack_length_compress", "--framepack_ratio 2", "--context_memory_frames 5"),
    ...
    MemoryProfileSpec(
        ...
        ckpt_substrings=("memory_baselines_basic_framepack_lencompress_r4",),
        paper_tag="arXiv:2504.12626",
        train_flags=("--use_framepack_length_compress", "--framepack_ratio 4", "--context_memory_frames 5"),
    ...
    MemoryProfileSpec(
        ...
        ckpt_substrings=("memory_baselines_basic_videossm_hybrid",),
